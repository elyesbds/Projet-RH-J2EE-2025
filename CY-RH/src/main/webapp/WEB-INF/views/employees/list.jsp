                            ...
                            <tr>
                                ...
                                <c:if test="${canModify || sessionScope.userRole == 'CHEF_PROJET'}">
                                    <td class="actions">
                                        ...
                                        <c:if test="${canModify}">
                                            <a href="${pageContext.request.contextPath}/employees/edit?id=${employee.id}" class="btn-edit">✏️ Modifier</a>
                                            <a href="${pageContext.request.contextPath}/employee-projets?employeeId=${employee.id}" class="btn-projects">📊 Projets</a>
