...
<div class="container">
    ...
    <table class="employee-table">
        ...
        <tr>
            <th>
                <a href="${pageContext.request.contextPath}/departements?sortBy=intitule&order=${order == 'ASC' ? 'DESC' : 'ASC'}"
                   style="color: inherit; text-decoration: none;">
                    Intitulé ${sortBy == 'intitule' ? (order == 'ASC' ? '▲' : '▼') : ''}
                </a>
            </th>

            <th>
                <a href="${pageContext.request.contextPath}/departements?sortBy=chef&order=${order == 'ASC' ? 'DESC' : 'ASC'}"
                   style="color: inherit; text-decoration: none;">
                    Chef de département ${sortBy == 'chef' ? (order == 'ASC' ? '▲' : '▼') : ''}
                </a>
            </th>
            ...
            <c:otherwise>
                <c:forEach var="dept" items="${departements}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/departements/members?id=${dept.id}"
                        ...
                        <td class="actions">
                            <c:choose>
                                <c:when test="${sessionScope.userRole == 'ADMIN'}">
                                    <a href="${pageContext.request.contextPath}/departements/edit?id=${dept.id}"
                                ...
                                <c:when test="${sessionScope.userRole == 'CHEF_DEPT' && dept.chefDepartement != null && dept.chefDepartement.id == sessionScope.userId}">
                                    <a href="${pageContext.request.contextPath}/departements/edit?id=${dept.id}"
                                       class="btn-edit">Modifier mon département</a>
                                </c:when>
                            </c:choose>
                        </td>
                    </tr>
