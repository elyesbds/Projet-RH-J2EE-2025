...
<body>
    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/departements/affecter" method="post" class="employee-form">
            ...
            <div class="form-actions">
                ...
                <a href="${pageContext.request.contextPath}/departements/members?id=${departement.id}" class="btn btn-secondary">
                    Annuler
                </a>
            </div>
        </form>
